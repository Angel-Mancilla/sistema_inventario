...
<main class="container  w-11/12  mx-auto p-4 ">
    ...
    <div>
        <h1 class="text-green-800 font-bold px-4">Añadir Usuario</h1>

    </div>
    <br>
    <form action="{{route('usuario.store')}}" method="POST" class="p-3 max-w-min bg-neutral-600 backdrop-blur-sm shadow-md border rounded border-none">
        @csrf
        <label for="" class="font-bold">
            <span class="text-blue-100">Nombre del usuario:</span>
            <br>
            <input type="text" autocomplete="off" name="name" value="{{old('name')}}"  class="border border-2 rounded-md bg-fuchsia-100 border-sky-400 outline-none">
        </label>
        @error('name')
        ...
        <label for="" class="font-bold">
            ...
            <br>
            <input type="text" autocomplete="off" name="email"  value="{{old('email')}}" class="border border-2 rounded-md bg-fuchsia-100 border-sky-400 outline-none">
        </label>
        @error('email')
            <p class="text-red-500">{{$message}}</p>
        @enderror
        ...
        <label for="" class="text-blue-100 font-bold">
            <span class="text-blue-100">Rol:</span> 
            <br> 
        ...
        <br><br>
        <label for="" class="font-bold">
            <span class="text-blue-100">Contrasenia:</span>
            <br>
