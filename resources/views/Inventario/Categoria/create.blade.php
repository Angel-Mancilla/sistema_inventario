...
<main class="container  w-11/12  mx-auto p-4 ">
    ...
    <div>
        <h1 class="text-green-800 font-bold px-4">Añadir Categoria</h1>

    </div>
    <br>
    <form action="{{route('categoria.store')}}" method="POST" class="p-3 max-w-min bg-neutral-600 backdrop-blur-sm shadow-md border rounded border-none">
        @csrf
        <label for="" class="font-bold">
            <span class="text-blue-100">Nombre de la categoria:</span>
            <br>
